            ...
            defaultConfig() {
                ...
                return {
                    ...
                    eventAfterAllRender(...args) {
                        ...
                        self.$emit('event-all-render', ...args)
                    },
                    viewRender(...args) {
                        if (this.sync) {
                            self.events = cal.fullCalendar('clientEvents')
                    ...
                    eventDrop(...args) {
                        console.log("Here is were it is emited");
                        self.$emit('event-drop', ...args)
                    },

                    eventReceive(...args) {
                        console.log("Here is were it is emited - receive");
                    ...
                    eventResizeStart(...args){
                        self.$emit('event-resize-start', ...args)
                    },
                    eventDragStart(...args){
                        self.$emit('event-drag', ...args)
                    },
                    eventDragStop(...args){
                        self.$emit('event-dragStop', ...args)
                    },
                    dayClick(...args){
